...
fileOut2.close();
    ...
    private static void insertCoursesRecords(DBApp dbApp, int limit) throws Exception {
        BufferedReader coursesTable = new BufferedReader(new FileReader("C:\\Users\\legion\\Downloads\\omar Projects\\data base 2\\courses_table.csv"));
        String record;
 ...
 private static void insertStudentRecords(DBApp dbApp, int limit) throws Exception {
        BufferedReader studentsTable = new BufferedReader(new FileReader("C:\\Users\\legion\\Downloads\\omar Projects\\data base 2\\students_table.csv"));
        String record;
        int c = limit;
        if (limit == -1) {
            c = 1;
 ...
 private static void insertTranscriptsRecords(DBApp dbApp, int limit) throws Exception {
        BufferedReader transcriptsTable = new BufferedReader(new FileReader("C:\\Users\\legion\\Downloads\\omar Projects\\data base 2\\transcripts_table.csv"));
        String record;
        Hashtable<String, Object> row = new Hashtable<>();
        int c = limit;
        if (limit == -1) {
 ...
 private static void insertPCsRecords(DBApp dbApp, int limit) throws Exception {
        BufferedReader pcsTable = new BufferedReader(new FileReader("C:\\Users\\legion\\Downloads\\omar Projects\\data base 2\\pcs_table.csv"));
        String record;
        Hashtable<String, Object> row = new Hashtable<>();
        int c = limit;
        if (limit == -1) {
...
//	      insertPCsRecords(db,50);
//	      insertTranscriptsRecords(db,50);
//	      insertStudentRecords(db,500);
//	      insertCoursesRecords(db,500);
//	    printTableContents("students");
	    
//	    Hashtable<String, Object> htblColNameValue = new Hashtable<String, Object>( ); 
////	    htblColNameValue.put("id",  new String("82-8772"));
//	    htblColNameValue.put("first_name",  new String("Nora"));
//	    htblColNameValue.put("last_name",  "Sadek");
//	    htblColNameValue.put("gpa",  new Double(1.12));  
//	    htblColNameValue.put("dob",  new Date(2012-1900, 12-1, 31));
//	    db.updateTable( "students" , "82-8772", htblColNameValue );
//	    
//	    printTableContents("students");
